...
def comparar_producto(inventario, nombre):  
    for i, producto in enumerate(inventario):  
        if producto["nombre"] == nombre:  
            return i  # Retorna el índice del producto existente  
...
def main():  
    crear_archivo_inventario()  # Asegurar de que el archivo exista  
    inventario = cargar_inventario()  
    while True:  
        print("----- Gestión de Inventarios -----")  
        print(' 1) Crear Producto \n 2) Mostrar Productos\n 3) Mostrar Producto\n 4) Actualizar Producto\n 5) Eliminar Producto\n 6) Salir')  
        escoger = input("Ingrese una opción: ")
        if escoger == 1:  
            ...
            print("Solo debe ingresar números del 1 al 6.")
